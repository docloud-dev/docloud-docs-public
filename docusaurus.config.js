  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'Facebook',
                href: 'https://www.facebook.com/docloudapp',
              },
              {
                label: 'Instagram',
                href: 'https://www.instagram.com/docloud.app/',
              },
              {
                label: 'Tiktok',
                href: 'https://www.tiktok.com/@docloud.app',
              },
            ],
          },
          {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} DoCloud`,
      },
      prism: {
