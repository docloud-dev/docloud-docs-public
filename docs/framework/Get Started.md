...
1. Make sure you meet all the required prerequisites. Afterward, download the framework zip file from the DO Cloud by [clicking here](Docloud%200ba197d327db4e4eb668094ca07703eb.md).
2. Next, place the downloaded zip file in the "public_html" directory and extract its contents.
3. Proceed to the next section titled [Let’s Install Do Framework](Get%20Started%2050c5324171de4a79aca19c727c7ebe4c.md) for step-by-step instructions on installing the DoFramework.
